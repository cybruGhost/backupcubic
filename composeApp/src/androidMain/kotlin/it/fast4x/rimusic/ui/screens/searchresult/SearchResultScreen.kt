...
fun SearchResultScreen(
    ...
    val (gridStatesPref, onGridStatesPrefChanged) = rememberPreference(it.fast4x.rimusic.utils.Preference.SEARCH_RESULT_GRID_STATES.key, it.fast4x.rimusic.utils.Preference.SEARCH_RESULT_GRID_STATES.default)
