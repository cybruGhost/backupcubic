...
object SpotifyApiConfig {
    // Configuration URL
    private const val CONFIG_URL = "https://spotify-playlist_config.json"
    
    // Default URLs tuseme fallback and quick fetching
    private const val DEFAULT_MATCH_API = "https://spotifyap/api/spotify/match"
    private const val DEFAULT_CANVAS_API = "https://spotifyap/api/canvas"
