...
object Environment {
    ...
    val _7ZoUy0mkCP = EnvironmentPreferences.preference?.p37 ?: "Cgt"
    val _uMYwa66ycM = EnvironmentPreferences.preference?.p38 ?: ""
    val _3djbhqyLpE = EnvironmentPreferences.preference?.p1 ?: "/youtubei/v1/browse"
    val _NXIvG4ve8N = EnvironmentPreferences.preference?.p8 ?: "/youtubei/v1/next"
    val _cdSL7DrPbA = EnvironmentPreferences.preference?.p5 ?: "/youtubei/v1/player"
    val _QPWiB5riY1 = EnvironmentPreferences.preference?.p11 ?: "/youtubei/v1/music/get_queue"
    val _QPmE9fYezr = EnvironmentPreferences.preference?.p7 ?: "/youtubei/v1/search"
    val _Uwjb1AiI8t = EnvironmentPreferences.preference?.p13 ?: "/youtubei/v1/music/get_search_suggestions"
    val _qkHMinedvm = EnvironmentPreferences.preference?.p3 ?: "/youtubei/v1/account/account_menu"
    val _lvsJfaKiys = EnvironmentPreferences.preference?.p9 ?: "/youtubei/v1/playlist/create"
    val _YUxeqOcD7P = EnvironmentPreferences.preference?.p12 ?: "/youtubei/v1/playlist/delete"
    val _Pb7oepZC3P = EnvironmentPreferences.preference?.p4 ?: "/youtubei/v1/browse/edit_playlist"
    val _EWGT63Xrf0 = EnvironmentPreferences.preference?.p14 ?: "/youtubei/v1/subscription/subscribe"
    val _eR3hChvLRR = EnvironmentPreferences.preference?.p10 ?: "/youtubei/v1/subscription/unsubscribe"
    val _wI7xC0jvaR = EnvironmentPreferences.preference?.p2 ?: "/youtubei/v1/like/like"
    val _1enRpaV4ei = EnvironmentPreferences.preference?.p6 ?: "/youtubei/v1/like/removelike"
    val _XsHo8IdebO = EnvironmentPreferences.preference?.p36 ?: "https://music.youtube.com"
    val _1Vv31MecRl = EnvironmentPreferences.preference?.p0 ?: "music.youtube.com"
